...
map <leader>ps :setlocal relativenumber!<cr>:setlocal list!<cr>:setlocal number!<cr>
...
"highlight ColorColumn ctermbg=#666666 guibg=#666666
"highlight MsgArea guifg=#aeafb0 guibg=#aeafb0
set colorcolumn=80
